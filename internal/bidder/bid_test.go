...
func TestLastMarketTrades(t *testing.T) {
	...
	sellOrder := NewBid(false, 10, 0)
	ob.PlaceLimitOrder(price, sellOrder)

	marketOrder := NewBid(true, 10, 0)
...
func TestLimit(t *testing.T) {
	l := NewLimit(10_000)
	buyOrderA := NewBid(true, 5, 0)
	buyOrderB := NewBid(true, 8, 0)
	buyOrderC := NewBid(true, 10, 0)
...
func TestPlaceLimitOrder(t *testing.T) {
	...
	sellOrderA := NewBid(false, 10, 0)
	sellOrderB := NewBid(false, 5, 0)
...
func TestPlaceMarketOrder(t *testing.T) {
	...
	sellOrder := NewBid(false, 20, 0)
	ob.PlaceLimitOrder(10_000, sellOrder)

	buyOrder := NewBid(true, 10, 0)
...
func TestPlaceMarketOrderMultiFill(t *testing.T) {
	...
	buyOrderA := NewBid(true, 5, 0) // filled fully
	buyOrderB := NewBid(true, 8, 0) // partially filled
	buyOrderC := NewBid(true, 1, 0)
	buyOrderD := NewBid(true, 1, 0)
